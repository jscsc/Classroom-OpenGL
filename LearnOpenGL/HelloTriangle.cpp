...
namespace HellowTriangle {
	...
	int main()
	{
		...
		// Generate one element buffer object, reference by ID
		unsigned int EBO;
		glGenBuffers(1, &EBO);
		...
		// Copy our vertices into the currently bound buffer, GL_ARRAY_BUFFER
