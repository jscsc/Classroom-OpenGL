...
namespace HelloTexturesChallengeOne {
	...
	int main()
	{
		...
		// Build shaders
		Shader ourShader("Assets//Shaders//hello_textures_shader.vs", "Assets//Shaders//hello_textures_challenge_one_shader.fs");
...
//int main() {
//
//	return HelloTexturesChallengeOne::main();
//
//}