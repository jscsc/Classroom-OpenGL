...
namespace HelloTransformationsChallengeTwo {
	...
	int main()
	{
		...
		// Build shaders
		Shader ourShader("Assets//Shaders//hello_transformations_shader.vs", "Assets//Shaders//hello_transformations_shader.fs");
		...
		while (!glfwWindowShouldClose(window))
		{
			...
			glUniformMatrix4fv(transformLoc, 1, GL_FALSE, &transform[0][0]); // <-- Same thing as glm::value_ptr :D
