...
namespace HelloTextures {
	...
	int main()
	{
		...
		// Build shaders
		Shader ourShader("Assets//HelloTextures//Shaders//hello_textures_shader.vs", "Assets//HelloTextures//Shaders//hello_textures_shader.fs");
		...
		//Assets//HelloTextures//Textures//container.jpg
